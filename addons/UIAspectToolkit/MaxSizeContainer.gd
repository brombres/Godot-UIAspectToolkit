...
# Made by Matthieu Huvé (https://github.com/MattUV/godot-MaxSizeContainer)
# Ported for Godot 4 Beta 10 by Benedikt Wicklein
# Updated for Godot 4.x and aspect modes added by Brom Bresenham (tested on Godot 4.2-dev2)
